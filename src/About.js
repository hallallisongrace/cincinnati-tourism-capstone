...
const About = () => {
  ...
  <div className="block">
      ...
      <p className="">Explore our 52 neighborhoods in our expansive city limits. There is so much to see and experience. Each neighborhood is unique and special with its attractions, businesses, and histories; go on and find your new home away from home. </p>
  <section>
  ...
  <div className="block">
    <p className="header3">Sophistication for the Refined Traveler</p>
    <p>From Music Hall to our art museums, galleries, theaters, and playhouses, Cincinnat's vibrant arts' scene is alive and well.</p>
    <section>
  </section>
    </div>
